...
# cite from https://github.com/vuthuyduong/fungiclassifiers/blob/master/models/CNN/fasta2matrix.py
import sys
import math
import numpy as np
#############################################################################
                ...
                for i_kmer in range(0, k):
                    for letter in alphabet:
                        ...
                        if (kmer[i_kmer:i_kmer+1] != letter):
                            ...
                            if (neighbor in kmer_counts[bin_num].keys()):
...
def find_revcomp (sequence,
    ...
    if (sequence in revcomp_dictionary.keys()):
