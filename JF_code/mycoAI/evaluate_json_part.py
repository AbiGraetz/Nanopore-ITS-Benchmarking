...
# path = sys.argv[1]
# "/media/largeData/Jinghang/benchmark/mycoAI/minQ17/"

csv_file_path = sys.argv[1]
# path + "cnn_result_Mock1/"
output_file_name = sys.argv[2]
# path + "cnn_result_Mock1_Qmin17.json"
csv_files = set()
...
ref_dict = {}
with open("/media/largeData/Jinghang/benchmark/taxonomy.json", 'r') as json_file:
